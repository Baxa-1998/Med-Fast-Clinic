...
export default function Adress() {
  ...
  <div className='adress__map'> 
    <div className='adress__item'>
      ...
      <ul>
        <li><a href="#"> <Image loading='lazy' width={26} height={26} alt='location' src={'/assets/location.png'}/>Адрес: ул. Озод Шарк, 8</a></li>
        <li><a href="#"> <Image loading='lazy' width={26} height={26} alt='mobile' src={'/assets/mobile.png'}/>(95) 621 03 03</a></li>
        <li><a href="#"> <Image loading='lazy' width={26} height={26} alt='mobile' src={'/assets/mobile.png'}/>(95) 608 03 03</a></li>
        
      </ul>
      <Button title={'Оставить заявку'}/>
      <div className='address__item_rating'>
        <h3 className='adress__item_title'>Наши рейтинги</h3>
      <Image loading='lazy' width={127} height={38} alt='google' src={'/assets/google.png'}/>
      <Image loading='lazy' width={114} height={26} alt='rating' src={'/assets/rating.png'}/>
      </div>
    </div>
