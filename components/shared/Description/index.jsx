    ...
    <section className="description">
      ...
      <div className="description__info">
        ...
        <p id="description-text">
          ...
          благополучной жизни, поэтому с особым трепетом относимся <br /> к потребностям наших
          пациентов и их семей.
        </p>
        <h3 id="description-text">Почему выбирают нас?</h3>
        <p id="description-text">
          1. Комплексный подход к здоровью всей семьи. Наша клиника предоставляет медицинские услуги
          для детей и взрослых, <br /> а также для пожилых пациентов. Мы верим в важность
          профилактики и предлагаем регулярные обследования, скрининги и индивидуальные <br />{' '}
          программы мониторинга, чтобы помогать нашим пациентам оставаться здоровыми и энергичными.{' '}
          <br /> 2. Высококвалифицированные врачи. В команде клиники работают опытные специалисты
          разных профилей – педиатры, терапевты, кардиологи, неврологи, хирурги и многие другие.{' '}
          <br /> Наши врачи постоянно повышают квалификацию, чтобы предлагать пациентам самые
          современные методы диагностики и лечения. <br /> 3. Современное оборудование. Наша клиника
          ...
          оптимальные планы лечения. <br />
          4. Индивидуальный подход и комфортные условия. Мы понимаем, что медицинская помощь требует{' '}
          <br />
          ...
          вниманием. 5. Удобное расположение и график работы. Наша клиника расположена в удобном
          месте и предлагает гибкий <br /> график работы, включая вечерние и выходные часы, чтобы
          каждый пациент мог найти время для заботы о здоровье.
        </p>
        ...
        <p id="description-text">
          ...
          можно достичь лучших результатов в лечении. <br /> Здоровье семьи – это наша главная задача,
          поэтому мы создаем медицинское учреждение, куда хочется возвращаться не только за помощью, <br />
